...
const age = 69;
const discount =
  age < 18 ? 10 : age >= 18 && age <= 65 ? 20 : age > 65 ? 35 : 0;
...
const tariff = prompt("Укажите тип доставки: Стандарт, Экспресс, Премиум");
const baseСost =
  weight < 1
    ? weight * 5
    : weight >= 1 && weight <= 5
...
if (weight <= 0) {
  ...
  alert("Идет расчет стоимости доставки");
}
...
alert(`Итоговая стоимость доставки: ${baseСost * coefficient}$.`);
